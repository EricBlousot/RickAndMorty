    ...
    render() {
        return (
            <div className="col d-flex flex-row justify-content-center">
                ...
                <div class="btn-group dropup d-none d-md-block">
                    <button disabled={this.state.disabled} type="button" class="btn btn-outline-secondary dropdown-toggle m-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Résultats par page</button>
